                ...
                >
                    ...
                    <Form name="login-form" layout="vertical" onFinish={onFinish} disabled={loading}>
                        ...
                        <p style={{ textAlign: "center", marginTop: "10px" }}>
                            Bạn không có tài khoản? <a href="/signup" style={{ color: "#1a73e8", fontWeight: "bold" }}>Đăng Ký</a>
                        </p>
                        <p style={{ textAlign: "center", marginTop: "10px" }}>
                            Bạn quên mật khẩu? <a href="/resetpassword" style={{ color: "#1a73e8", fontWeight: "bold" }}>Đặt lại mật khẩu</a>
                        </p>
                        <p style={{ textAlign: "center", marginTop: "10px" }}>
                            Bạn là chủ doanh nghiệp ẩm thực? <a href="/loginBusiness" style={{ color: "#1a73e8", fontWeight: "bold" }}>Đăng nhập Business</a>
                        </p>
                    </Form>
                </Card>
            </Col>
